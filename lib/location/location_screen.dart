...
class LocationScreen extends StatelessWidget {
  ...
  final List<Location> locations = [
    ...
    Location(
        ...
        description2:
            'Dahab, located on the southeast coast of the Sinai Peninsula in Egypt,'
    ...
    Location(
        ...
        description2:
            'El Gouna, a chic and eco-friendly resort town near Hurghada,'
    ...
    Location(
        ...
        description1: "Explore history, culture, and modern attractions.",
        description2:
            'Sharm El-Sheikh, a resort town on the southern tip of the Sinai Peninsula,'
